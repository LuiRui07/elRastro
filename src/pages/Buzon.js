    ...
    <div style={{ textAlign: 'center' }}>
      ...
      {mensajes.length > 0 ? (
        mensajes.map((grupo) => { 
          ...
          return (
          <div key={grupo._id}>                                                         
            <div className="card mb-3" onClick={() => window.location.href = (user.user !== grupo.mensajes[0].remitente) ? `/chat/${grupo._id}/${grupo.mensajes[0].remitente}/${grupo.mensajes[0].destinatario}` : `/chat/${grupo._id}/${grupo.mensajes[0].destinatario}/${grupo.mensajes[0].remitente}`}>
